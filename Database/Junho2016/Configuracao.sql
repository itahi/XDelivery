alter table Empresa add HorarioFuncionamento nvarchar(max);
GO
...
Insert into Empresa (nome,CNPJ,Telefone ,Telefone2,Contato,Cep,
					...
					Servidor,Banco,DataInicio,VersaoBanco,strConnectionResult,UrlServidor,HorarioFuncionamento)
            Values (@Nome,@CNPJ,@Telefone,@Telefone2,@Contato,@Cep,
			       @Endereco,@Cidade,@Bairro,@Numero,@UF,@PontoReferencia,
				   @Servidor,@Banco,@DataInicio,@VersaoBanco,@CaminhoBackup,@UrlServidor,@HorarioFuncionamento)
GO
