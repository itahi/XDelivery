alter table Configuracao add ExigeVendedorSN bit;
GO
...
insert into Configuracao (ImpViaCozinha,UsaDataNascimento,UsaLoginSenha,QtdCaracteresImp,
						  ...
						  ViasEntrega,ViasCozinha,ViasBalcao,RepeteUltimoPedido,RegistraCancelamentos,DadosApp,Pushauthorization,Pushapp_id,CidadesAtendidas,ExigeVendedorSN)
						  values
