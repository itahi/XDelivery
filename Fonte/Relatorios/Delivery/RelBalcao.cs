...
namespace DexComanda.Relatorios.Delivery {
    ...
    public class RelBalcao : ReportClass {
    ...
    public class CachedRelBalcao : Component, ICachedReport {
        
        public CachedRelBalcao() {
        }
